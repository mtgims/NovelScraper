...
from .api import auth, books, collections, config, imports, jobs, relay, sites, stats, sync, tts
...
app.include_router(sync.router, prefix="/api/sync", tags=["sync"], dependencies=authed)
